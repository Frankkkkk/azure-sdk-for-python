...
class ComputeManagementClient(MultiApiClientMixin, _SDKClient):
    ...
    @property
    @api_version_validation(
        method_valid_on=['2016-04-30-preview', '2017-03-30', '2018-04-01', '2018-06-01', '2018-09-30', '2019-03-01', '2019-07-01', '2019-11-01', '2020-05-01', '2020-06-30', '2020-09-30', '2020-12-01', '2021-04-01', '2021-08-01', '2021-12-01', '2022-03-02', '2022-07-02']
    )
    def disks(self):
    ...
    @property
    @api_version_validation(
        method_valid_on=['2019-07-01', '2019-11-01', '2020-05-01', '2020-06-30', '2020-09-30', '2020-12-01', '2021-04-01', '2021-08-01', '2021-12-01', '2022-03-02', '2022-07-02']
    )
    ...
    @property
    @api_version_validation(
        method_valid_on=['2020-05-01', '2020-06-30', '2020-09-30', '2020-12-01', '2021-04-01', '2021-08-01', '2021-12-01', '2022-03-02', '2022-07-02']
    )
    ...
    @property
    @api_version_validation(
        method_valid_on=['2020-09-30', '2020-12-01', '2021-04-01', '2021-08-01', '2021-12-01', '2022-03-02', '2022-07-02']
    )
